...
class CampaignDeskProductionTests(unittest.TestCase):
    ...
    def test_campaign_desk_keeps_reader_and_live_assistant_together(self) -> None:
        ...
        self.assertIn("const renderCompletion = render();", assistant_html)
        self.assertIn("if (renderCompletion && typeof renderCompletion.then === 'function') await renderCompletion;", assistant_html)
        self.assertIn("return renderStoryInto(storyPanel, 'campaign');", assistant_html)
